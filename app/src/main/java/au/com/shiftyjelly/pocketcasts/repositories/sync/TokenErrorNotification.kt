    ...
    fun show(intent: Intent) {
        ...
        if (ActivityCompat.checkSelfPermission(context, Manifest.permission.POST_NOTIFICATIONS) == PackageManager.PERMISSION_GRANTED) {
            ...
            val notification = NotificationCompat.Builder(context, Settings.NotificationChannel.NOTIFICATION_CHANNEL_ID_SIGN_IN_ERROR.id)
                ...
                .setContentTitle(context.getString(R.string.token_refresh_sign_in_error_title))
                .setContentText(context.getString(R.string.token_refresh_sign_in_error_description))
                .setAutoCancel(true)
