...
class FunnyTimeConverter {
    ...
    private val TIME_UNITS = arrayOf(
        FunnyTimeUnit(R.string.settings_stats_funny_babies, 250.0),
        FunnyTimeUnit(R.string.settings_stats_funny_blinked, 7.0),
        FunnyTimeUnit(R.string.settings_stats_funny_lightning, 360.0),
        FunnyTimeUnit(R.string.settings_stats_funny_skin, 583.0),
        FunnyTimeUnit(R.string.settings_stats_funny_sneezed, 0.00694),
        FunnyTimeUnit(R.string.settings_stats_funny_emails, 100000000.0),
        FunnyTimeUnit(R.string.settings_stats_funny_tweets, 121527.77),
        FunnyTimeUnit(R.string.settings_stats_funny_air_biscuits, 0.0118),
        FunnyTimeUnit(R.string.settings_stats_funny_laces, 6.0),
        FunnyTimeUnit(R.string.settings_stats_funny_air_balloon, 0.000051994),
        FunnyTimeUnit(R.string.settings_stats_funny_searches, 2276867.0),
    )

    fun timeSecsToFunnyText(timeSecs: Long, resources: Resources): String {
        // don't bother if the listening time is less than 1 minute
        if (timeSecs < 60) {
            return resources.getString(R.string.settings_stats_funny_empty)
        }
