...
internal class LargeListRowAdapter(
    ...
    class LargeListItemViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val placeholderDrawable = itemView.context.getThemeDrawable(R.attr.defaultArtworkSmall)
    ...
    override fun onBindViewHolder(holder: LargeListItemViewHolder, position: Int) {
        ...
        if (podcast is DiscoverPodcast) {
            ...
            holder.btnSubscribe.setOnClickListener {
                holder.btnSubscribe.updateSubscribeButtonIcon(subscribed = true, colorSubscribed = R.attr.contrast_01, colorUnsubscribed = R.attr.contrast_01)
                fromListId?.let {
            ...
            holder.btnSubscribe.updateSubscribeButtonIcon(subscribed = podcast.isSubscribed, colorSubscribed = R.attr.contrast_01, colorUnsubscribed = R.attr.contrast_01)
