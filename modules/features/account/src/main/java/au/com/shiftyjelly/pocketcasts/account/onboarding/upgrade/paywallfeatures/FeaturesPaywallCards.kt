...
private val bookmarks = CardData(
    imageResId = R.drawable.bookmarks,
    contentDescriptionResourceId = R.string.paywall_bookmarks_content_description,
    titleResourceId = R.string.paywall_bookmarks_title,
    descriptionResourceId = R.string.paywall_bookmarks_description,
    imageHeight = 224.dp,
    imageTopPadding = 37.dp,
)

private val folders = CardData(
    imageResId = R.drawable.folders,
    contentDescriptionResourceId = R.string.paywall_folders_content_description,
    titleResourceId = R.string.paywall_folders_title,
    descriptionResourceId = R.string.paywall_folders_description,
    imageHeight = 227.dp,
    imageTopPadding = 34.dp,
)

private val desktop = CardData(
    imageResId = R.drawable.desktop,
    contentDescriptionResourceId = R.string.paywall_desktop_and_web_content_description,
    titleResourceId = R.string.paywall_desktop_and_web_title,
    descriptionResourceId = R.string.paywall_desktop_and_web_description,
    imageHeight = 186.dp,
...
private val watch = CardData(
    ...
    contentDescriptionResourceId = R.string.paywall_watch_content_description,
    titleResourceId = R.string.paywall_watch_title,
    descriptionResourceId = R.string.paywall_watch_description,
    imageHeight = 231.dp,
    imageTopPadding = 26.dp,
)

private val slumber = CardData(
    imageResId = R.drawable.slumber,
    contentDescriptionResourceId = R.string.paywall_slumber_studios_content_description,
    titleResourceId = R.string.paywall_slumber_studios_title,
    descriptionResourceId = R.string.paywall_slumber_studios_description,
    imageHeight = 195.dp,
...
private val storage = CardData(
    ...
    contentDescriptionResourceId = R.string.paywall_storage_content_description,
    titleResourceId = R.string.paywall_storage_title,
    descriptionResourceId = R.string.paywall_storage_description,
    imageHeight = 163.dp,
    imageTopPadding = 64.dp,
)

private val themes = CardData(
    imageResId = R.drawable.themes,
    contentDescriptionResourceId = R.string.paywall_themes_content_description,
    titleResourceId = R.string.paywall_themes_title,
    descriptionResourceId = R.string.paywall_themes_description,
    imageHeight = 84.dp,
