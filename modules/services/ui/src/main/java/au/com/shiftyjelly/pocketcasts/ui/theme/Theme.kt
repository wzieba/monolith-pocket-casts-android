...
class Theme @Inject constructor(private val settings: Settings) {
    ...
    enum class ThemeType(
        ...
        LIGHT(
            ...
            labelId = R.string.settings_theme_light,
            resourceId = R.style.ThemeLight,
            iconResourceId = R.drawable.ic_apptheme0,
        ...
        DARK(
            ...
            labelId = R.string.settings_theme_dark,
            resourceId = R.style.ThemeDark,
            iconResourceId = R.drawable.ic_apptheme1,
        ...
        ROSE(
            ...
            labelId = R.string.settings_theme_rose,
            resourceId = R.style.Rose,
            iconResourceId = R.drawable.ic_theme_rose,
            defaultLightIcons = false,
            darkTheme = false,
            isPlus = false,
        ),
        INDIGO(
            ...
            labelId = R.string.settings_theme_indigo,
            resourceId = R.style.Indigo,
            iconResourceId = R.drawable.ic_indigo,
            defaultLightIcons = true,
            darkTheme = false,
            isPlus = false,
        ),
        EXTRA_DARK(
            ...
            labelId = R.string.settings_theme_extra_dark,
            resourceId = R.style.ExtraThemeDark,
            iconResourceId = R.drawable.ic_apptheme2,
            defaultLightIcons = true,
            darkTheme = true,
            isPlus = false,
        ),
        DARK_CONTRAST(
            ...
            labelId = R.string.settings_theme_dark_contrast,
            resourceId = R.style.DarkContrast,
            iconResourceId = R.drawable.ic_apptheme6,
            defaultLightIcons = true,
            darkTheme = true,
            isPlus = false,
        ),
        LIGHT_CONTRAST(
            ...
            labelId = R.string.settings_theme_light_contrast,
            resourceId = R.style.LightContrast,
            iconResourceId = R.drawable.ic_apptheme7,
            defaultLightIcons = false,
            darkTheme = false,
            isPlus = false,
        ),
        ELECTRIC(
            ...
            labelId = R.string.settings_theme_electricity,
            resourceId = R.style.Electric,
            iconResourceId = R.drawable.ic_apptheme5,
            defaultLightIcons = true,
            darkTheme = true,
            isPlus = true,
        ),
        CLASSIC_LIGHT(
            ...
            labelId = R.string.settings_theme_classic, // "Classic Light"
            resourceId = R.style.ClassicLight,
            iconResourceId = R.drawable.ic_apptheme3,
            defaultLightIcons = true,
            darkTheme = false,
            isPlus = true,
        ),
        RADIOACTIVE(
            ...
            labelId = R.string.settings_theme_radioactivity,
            resourceId = R.style.Radioactive,
            iconResourceId = R.drawable.ic_theme_radioactive,
            defaultLightIcons = true,
            darkTheme = true,
            isPlus = true,
        ),
    ...
    fun verticalPlusLogoRes() =
        if (isDarkTheme) R.drawable.plus_logo_vertical_dark else R.drawable.plus_logo_vertical_white
}
