...
class SelectablePanel @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var currentSelectColor: Int = context.getThemeColor(R.attr.primary_interactive_01)
    private var currentDeselectColor: Int = context.getThemeColor(R.attr.primary_ui_05)
